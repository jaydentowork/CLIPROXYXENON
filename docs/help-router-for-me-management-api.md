[Skip to content](https://help.router-for.me/management/api#VPContent)

On this page

# Management API [​](https://help.router-for.me/management/api\#management-api)
...
## Authentication [​](https://help.router-for.me/management/api\#authentication)
...
## Request/Response Conventions [​](https://help.router-for.me/management/api\#request-response-conventions)
...
## Endpoints [​](https://help.router-for.me/management/api\#endpoints)

### Usage Telemetry Queue [​](https://help.router-for.me/management/api\#usage-telemetry-queue)
...
- For per-request usage records as JSON, use the [Redis Usage Queue](https://help.router-for.me/management/redis-usage-queue.html) (RESP) exposed on the same port as HTTP.
...
### Config [​](https://help.router-for.me/management/api\#config)
...
### Latest Version [​](https://help.router-for.me/management/api\#latest-version)
...
### Debug [​](https://help.router-for.me/management/api\#debug)
...
### Config YAML [​](https://help.router-for.me/management/api\#config-yaml)
...
### Logging to File [​](https://help.router-for.me/management/api\#logging-to-file)
...
### Log Files [​](https://help.router-for.me/management/api\#log-files)
...
### Request Error Logs [​](https://help.router-for.me/management/api\#request-error-logs)
...
### Usage Statistics Toggle [​](https://help.router-for.me/management/api\#usage-statistics-toggle)
...
### Proxy Server URL [​](https://help.router-for.me/management/api\#proxy-server-url)
...
### Quota Exceeded Behavior [​](https://help.router-for.me/management/api\#quota-exceeded-behavior)
...
### API Keys (proxy service auth) [​](https://help.router-for.me/management/api\#api-keys-proxy-service-auth)
...
### Gemini API Key [​](https://help.router-for.me/management/api\#gemini-api-key)
...
### Codex API KEY (object array) [​](https://help.router-for.me/management/api\#codex-api-key-object-array)
...
### Request Retry Count [​](https://help.router-for.me/management/api\#request-retry-count)
...
### Max Retry Interval [​](https://help.router-for.me/management/api\#max-retry-interval)
...
### Request Log [​](https://help.router-for.me/management/api\#request-log)
...
### WebSocket Authentication (`ws-auth`) [​](https://help.router-for.me/management/api\#websocket-authentication-ws-auth)
...
### Claude API KEY (object array) [​](https://help.router-for.me/management/api\#claude-api-key-object-array)
...
### OpenAI Compatibility Providers (object array) [​](https://help.router-for.me/management/api\#openai-compatibility-providers-object-array)
...
### OAuth Excluded Models [​](https://help.router-for.me/management/api\#oauth-excluded-models)
...
### Auth File Management [​](https://help.router-for.me/management/api\#auth-file-management)
...
### Vertex Credential Import [​](https://help.router-for.me/management/api\#vertex-credential-import)
...
### Login/OAuth URLs [​](https://help.router-for.me/management/api\#login-oauth-urls)
...
### Plugins [​](https://help.router-for.me/management/api\#plugins)
...
### Additional Runtime Settings and Logs [​](https://help.router-for.me/management/api\#additional-runtime-settings-and-logs)
...
### Additional Provider API Key Collections [​](https://help.router-for.me/management/api\#additional-provider-api-key-collections)
...
### OAuth Model Aliases [​](https://help.router-for.me/management/api\#oauth-model-aliases)
...
### Auth File Extensions [​](https://help.router-for.me/management/api\#auth-file-extensions)
...
### Authenticated Upstream Calls [​](https://help.router-for.me/management/api\#authenticated-upstream-calls)
...
### Additional OAuth Flows and Callback [​](https://help.router-for.me/management/api\#additional-oauth-flows-and-callback)
...
### Examples for Newly Added Endpoints [​](https://help.router-for.me/management/api\#examples-for-newly-added-endpoints)

All examples below except the unauthenticated `/oauth-callback` examples require `Authorization: Bearer <MANAGEMENT_KEY>`.

#### Plugins [​](https://help.router-for.me/management/api\#plugins-1)
...
#### Runtime Settings and Logs [​](https://help.router-for.me/management/api\#runtime-settings-and-logs)
...
#### Provider API Key Collections [​](https://help.router-for.me/management/api\#provider-api-key-collections)
...
#### OAuth Aliases, Auth Files, and Upstream Calls [​](https://help.router-for.me/management/api\#oauth-aliases-auth-files-and-upstream-calls)
...
#### Device OAuth and Callback [​](https://help.router-for.me/management/api\#device-oauth-and-callback)
...
## Error Responses [​](https://help.router-for.me/management/api\#error-responses)
...
## Notes [​](https://help.router-for.me/management/api\#notes)
